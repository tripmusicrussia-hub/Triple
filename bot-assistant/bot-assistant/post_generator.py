...
RUBRIC_SCHEDULE: dict[int, Rubric] = {
    ...
    1: {
        ...
        "user_instruction": "Короткая фишка — 2-3 строки, один приём, без длинных объяснений. Формат: «попробуй X → эффект Y». Используй ТОЛЬКО плагины/технику из раздела 'Битмейкерский домен' в системном промпте. Без воды.",
    },
    2: {
        "name": "Hard Lifehack",
        "kind": "text",
