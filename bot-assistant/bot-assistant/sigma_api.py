...
2. qty — из колонки "Количество" (или "Кол-во", "Кол", "Кол."). Это обычно небольшое число: 1, 2, 5, 10, 20. НЕ путай с ценой или суммой.
3. price — вычисли как: (итоговая стоимость строки) / qty. Итоговая стоимость строки — это последняя числовая колонка строки ("Стоимость", "Сумма", "Стоимость с НДС" и т.п.). Например: стоимость строки 1975, qty 5 → price = 1975 / 5 = 395.
4. Строки без количества или с нулевым количеством — пропускай.
5. Итоговые строки ("Итого", "Всего") — не включай в товары.
6. name — ДОСЛОВНО как написано в накладной.
7. Поставщик — название ООО/ИП из шапки документа.
8. total_sum — итоговая сумма документа.
