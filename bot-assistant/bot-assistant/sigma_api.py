...
2. qty — из колонки "Количество" (или "Кол-во", "Кол", "Кол."). Это обычно небольшое число: 1, 2, 5, 10, 20. НЕ используй колонки "Сумма", "Цена", "Стоимость" — они не количество.
3. price — из колонки "Цена" (цена за единицу товара).
